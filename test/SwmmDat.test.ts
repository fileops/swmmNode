...
beforeAll(async () => {
  ...
  (global as any).rg_data04 = new SwmmDat(file04);
})
...
expect((global as any).rg_data04.subRange(new Date(Date.UTC(1974, 5 ,3, 23, 30)), new Date(Date.UTC(1974, 5 ,5, 3, 30))).stringify()).toEqual(`
